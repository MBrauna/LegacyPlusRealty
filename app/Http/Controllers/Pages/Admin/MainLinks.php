<?php
    ...
    class MainLinks extends Controller {
        public function list(Request $request) {
            try {
                $quickAccess    =   QuickAccess::orderBy('description','asc')->get();

                return view('pages.admin.quickAccess',[
        ...
        public function add(Request $request) {
            try {
                ...
                if(is_null($description) || is_null($url)) return redirect()->route('admin.link.list');
                ...
                return redirect()->route('admin.link.list');
            } // try { ... }
            catch(Exception $error) {
                return redirect()->route('dashboard.home');
            } // catch(Exception $error) { ... }
        ...
        public function remove(Request $request) {
            try {
                ...
                if(is_null($idQuickAccess)) return redirect()->route('admin.link.list');
