...
@section('body')
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped table-borderless table-sm" id="dataTable" cellspacing="0">
                    ...
                    @forelse ($groups as $group)
                        <tr>
                            <td class="text-white text-center bg-primary" style="min-width: 5vw;"><small>#{{ $group->id_group }}</small></td>
    ...
    <div class="modal fade" id="createGroup" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('admin.group.save') }}" class="modal-content was-validated" autocomplete="off">
    ...
    @foreach ($groups as $group)
        <div class="modal fade" id="createGroup_{{ $group->id_group }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="{{ route('admin.group.update') }}" class="modal-content was-validated" autocomplete="off">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="staticBackdropLabel">Register</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="idGroupForm" value="{{ $group->id_group }}">
                        <div class="row">
                            <div class="form-group col-sm-12 col-12 col-md-12">
                                <label for="nameForm">Name:</label>
