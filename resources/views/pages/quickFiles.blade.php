            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active pb-1 pt-1 pl-1" id="v-pills-archive-tab" data-toggle="pill" href="#v-pills-archive" role="tab" aria-controls="v-pills-archive" aria-selected="true">Files for {{ Auth::user()->last_name }}</a>

                        @foreach ($groups as $group)
                            <a class="nav-link pb-1 pt-1 pl-1" id="v-pills-{{ $group->id_users_group }}-tab" data-toggle="pill" href="#v-pills-{{ $group->id_users_group }}" role="tab" aria-controls="v-pills-{{ $group->id_users_group }}" aria-selected="true">{{ $group->name }}</a>
                        @endforeach
                    </div>
                </div>
                <div class="col-9">
                                        ...
                                        <tbody>
                                            @foreach ($archives as $archive)
                                                <tr>
                                                    ...
                                                    <td><small>{{ round($archive->length/1024,2).'kB' }}</small></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
